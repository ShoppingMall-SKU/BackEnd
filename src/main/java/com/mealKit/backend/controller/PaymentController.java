...
//        try {
//            int userId = paymentDTO.getOrdering().getUser().getPid(); // 수정 필요
//
...
//    public IamportResponse<com.siot.IamportRestClient.response.Payment> validateIamport(@PathVariable String imp_uid) throws IamportResponseException, IOException {
